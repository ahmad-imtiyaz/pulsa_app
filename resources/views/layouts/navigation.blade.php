<nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        ...
                        <span class="text-xl font-bold text-gray-900">{{ config('app.name', 'Bakul Pulsa') }}</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dompet-pulsa.index')" :active="request()->routeIs('dompet-pulsa*')">
                        {{ __('Dompet Pulsa') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('aksesoris.index')" :active="request()->routeIs('aksesoris*')">
                        {{ __('Aksesoris') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dompet-pulsa.index')" :active="request()->routeIs('dompet-pulsa*')">
                {{ __('Dompet Pulsa') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('aksesoris.index')" :active="request()->routeIs('aksesoris*')">
                {{ __('Aksesoris') }}
            </x-responsive-nav-link>
