<x-app-layout :title="'Tambah Transaksi Pulsa'">
    <div class="max-w-2xl mx-auto">
        ...
        <form method="POST" action="{{ route('dompet-pulsa.transaksi.store', $dompetPulsa) }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
            @csrf
    ...
    <script>
        // Initialize label on page load (for validation error recovery)
